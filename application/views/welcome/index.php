            ...
            <div class="col-lg-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <h4>
                            本店所得积分(<label style="color: #aa3e05;"><?=bcadd($formula_local->total_score, $formula_sub->total_volume, 0)?>分</label>) - 本店返点积分(<label style="color: #aa3e05;"><?=bcmul($formula_local->total_volume, 1)?>分</label>) = <label style="color:#aa3e05"><?=$auth_data->return_profit?>分</label>
                        </h4>
                        <h4>
                            <?=$auth_data->name?>
                        </h4>
                        ...
                        <table class="table table-striped table-bordered table-hover no-footer" <?if(count($action_logs)==0){?>style="display:none;"<?}?>>
                            ...
                            <? foreach ($action_logs as $l) { ?>
                                <tr>
                                    ...
                                    <td>￥<?=$l->volume?>元</td>
                                    <td><?=intval($l->score)>0?"0":bcmul($l->volume, 1)?>分</td>
                                </tr>
                            <?}?>
                            </tbody>
                        </table>

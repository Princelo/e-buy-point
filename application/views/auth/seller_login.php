...
<div class="login">
    <div class="login-main">
        <div class="login-top">
            <form action="<?=site_url('auth/seller_login')?>" method="post">
                ...
                <h1><span class="anc-color">欢迎登录</span> M平台 <span class="anc-color">业务管理系统</span> </h1>
                <img src="<?=IMAGES_URL?>seller.png" alt=""/>
